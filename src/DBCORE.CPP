...
RETCODE SQL_API AfxThunkSQLDescribeColA(HSTMT h, UWORD u, UCHAR* puch, SWORD s, SWORD* ps1, SWORD* ps2, UDWORD* pudw, SWORD* ps3, SWORD* ps4)
{
	ODBCLOAD(SQLDescribeColA);
	return _afxODBC.pfnSQLDescribeColA(h, u, puch, s, ps1, ps2, pudw, ps3, ps4);
}
...
#ifndef _MAC
RETCODE SQL_API AfxThunkSQLDriverConnectA(HDBC hdbc, HWND hwnd, UCHAR* puch1, SWORD s1, UCHAR* puch2, SWORD s2, SWORD* ps1, UWORD u)
#else
RETCODE SQL_API AfxThunkSQLDriverConnectA(HDBC hdbc, SQLHWND hwnd, UCHAR* puch1, SWORD s1, UCHAR* puch2, SWORD s2, SWORD* ps1, UWORD u)
#endif
{
	ODBCLOAD(SQLDriverConnectA);
	return _afxODBC.pfnSQLDriverConnectA(hdbc, hwnd, puch1, s1, puch2, s2, ps1, u);
}

RETCODE SQL_API AfxThunkSQLErrorA(HENV henv, HDBC hdbc, HSTMT hstmt, UCHAR* puch1, SDWORD* psdw, UCHAR* puch2, SWORD s, SWORD* ps)
{
	ODBCLOAD(SQLErrorA);
	return _afxODBC.pfnSQLErrorA(henv, hdbc, hstmt, puch1, psdw, puch2, s, ps);
}

RETCODE SQL_API AfxThunkSQLExecDirectA(HSTMT h, UCHAR* puch, SDWORD sdw)
{
	ODBCLOAD(SQLExecDirectA);
	return _afxODBC.pfnSQLExecDirectA(h, puch, sdw);
}
...
RETCODE SQL_API AfxThunkSQLGetCursorNameA(HSTMT h, UCHAR* puch, SWORD s, SWORD* ps)
{
	ODBCLOAD(SQLGetCursorNameA);
	return _afxODBC.pfnSQLGetCursorNameA(h, puch, s, ps);
}
...
RETCODE SQL_API AfxThunkSQLGetInfoA(HDBC h, UWORD u, PTR p, SWORD s, SWORD* ps)
{
	ODBCLOAD(SQLGetInfoA);
	return _afxODBC.pfnSQLGetInfoA(h, u, p, s, ps);
}
...
RETCODE SQL_API AfxThunkSQLPrepareA(HSTMT h, UCHAR* puch, SDWORD sdw)
{
	ODBCLOAD(SQLPrepareA);
	return _afxODBC.pfnSQLPrepareA(h, puch, sdw);
}
...
RETCODE SQL_API AfxThunkSQLSetConnectOptionA(HDBC h, UWORD u, UDWORD udw)
{
	ODBCLOAD(SQLSetConnectOptionA);
	return _afxODBC.pfnSQLSetConnectOptionA(h, u, udw);
}
...
BOOL CRecordset::FlushResultSet() const
{
	...
	// REVIEW: Temporary hack until DEF file fixed
