...
#ifdef _MAC
		// WLM requires you to remove a menu from the menu bar before
		// destroying it, so remove it now
		// REVIEW: remove this restriction from WLM
		// m_pInPlaceFrame->m_pFrameWnd->OnUpdateFrameMenu(NULL);
#endif
