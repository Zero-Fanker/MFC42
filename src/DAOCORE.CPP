...
void CDaoWorkspace::CommitTrans()
{
	...
	if (!bUseDao30)
	{
		// Call DAO 3.5 method with no option set.
	...
	else
	{
		...
		HRESULT (DAOWorkspace::*pMethod)() = (HRESULT (DAOWorkspace::*)())m_pDAOWorkspace->CommitTrans;
	...
	CDaoParameterInfo& paraminfo, DWORD dwOptions)
{
	...
	if (dwOptions & AFX_DAO_FETCH_PRIMARY_PROPERTIES)
	{
		...
		int nLength = _tcslen(pch);
		if (nLength > 0 && *pch == _T('[') && *(pch + nLength -1) == _T(']'))
		{
...
void AFX_CDECL AfxGetDefaultValue(DAOField* pDAOField, CString& strDefaultValue)
{
	...
	else
	{
		...
		HRESULT (DAOField::*pMethod)(BSTR*) = (HRESULT (DAOField::*)(BSTR*))pDAOField->get_DefaultValue;
...
void AFX_CDECL AfxSetDefaultValue(DAOField* pDAOField, CString& strDefaultValue)
{
	...
	else
	{
		...
		HRESULT (DAOField::*pMethod)(BSTR) = (HRESULT (DAOField::*)(BSTR))pDAOField->put_DefaultValue;
		DAO_CHECK((pDAOField->*pMethod)(V_BSTR(&var)));
	}
}
