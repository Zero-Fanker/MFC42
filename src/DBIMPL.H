...
struct AFX_ODBC_CALL
{
	...
	RETCODE (SQL_API* pfnSQLDescribeColA)(HSTMT, UWORD, UCHAR*, SWORD, SWORD*, SWORD*, UDWORD*, SWORD*, SWORD*);
	RETCODE (SQL_API* pfnSQLDisconnect)(HDBC);
#ifndef _MAC
	RETCODE (SQL_API* pfnSQLDriverConnectA)(HDBC, HWND, UCHAR*, SWORD, UCHAR*, SWORD, SWORD*, UWORD);
#else
	RETCODE (SQL_API* pfnSQLDriverConnectA)(HDBC, SQLHWND, UCHAR*, SWORD, UCHAR*, SWORD, SWORD*, UWORD);
#endif
	RETCODE (SQL_API* pfnSQLErrorA)(HENV, HDBC, HSTMT, UCHAR*, SDWORD*, UCHAR*, SWORD, SWORD*);
	RETCODE (SQL_API* pfnSQLExecDirectA)(HSTMT, UCHAR*, SDWORD);
	...
	RETCODE (SQL_API* pfnSQLGetCursorNameA)(HSTMT, UCHAR*, SWORD, SWORD*);
	RETCODE (SQL_API* pfnSQLGetData)(HSTMT, UWORD, SWORD, PTR, SDWORD, SDWORD*);
	RETCODE (SQL_API* pfnSQLGetFunctions)(HDBC, UWORD, UWORD*);
	RETCODE (SQL_API* pfnSQLGetInfoA)(HDBC, UWORD, PTR, SWORD, SWORD*);
	...
	RETCODE (SQL_API* pfnSQLPrepareA)(HSTMT, UCHAR*, SDWORD);
	RETCODE (SQL_API* pfnSQLPutData)(HSTMT, PTR, SDWORD);
	RETCODE (SQL_API* pfnSQLRowCount)(HSTMT, SDWORD*);
	RETCODE (SQL_API* pfnSQLSetConnectOptionA)(HDBC, UWORD, UDWORD);
...
#define SQLDescribeCol      _afxODBC.pfnSQLDescribeColA
#define SQLDisconnect       _afxODBC.pfnSQLDisconnect
#define SQLDriverConnect    _afxODBC.pfnSQLDriverConnectA
#define SQLError            _afxODBC.pfnSQLErrorA
#define SQLExecDirect       _afxODBC.pfnSQLExecDirectA
...
#define SQLGetCursorName    _afxODBC.pfnSQLGetCursorNameA
#define SQLGetData          _afxODBC.pfnSQLGetData
#define SQLGetFunctions     _afxODBC.pfnSQLGetFunctions
#define SQLGetInfo          _afxODBC.pfnSQLGetInfoA
...
#define SQLPrepare          _afxODBC.pfnSQLPrepareA
#define SQLPutData          _afxODBC.pfnSQLPutData
#define SQLRowCount         _afxODBC.pfnSQLRowCount
#define SQLSetConnectOption _afxODBC.pfnSQLSetConnectOptionA
