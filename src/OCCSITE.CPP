...
class IVBDSC : public IUnknown
{
public:
	// Interface Methods
	STDMETHOD(QueryInterface)(REFIID riid, void **ppvObjOut) = 0;
	STDMETHOD_(ULONG, AddRef)(void) = 0;
	STDMETHOD_(ULONG, Release)(void) = 0;
	STDMETHOD(CancelUnload)(THIS_ BOOL FAR *pfCancel) = 0;
	STDMETHOD(Error)(THIS_ DWORD dwErr, BOOL FAR *pfShowError) = 0;
	STDMETHOD(CreateCursor)(THIS_ ICursor FAR * FAR *ppCursor) = 0;
};
...
HRESULT CDataSourceControl::Initialize()
{
	...
	IVBDSC* pDSC;
	HRESULT hRes = m_pClientSite->m_pObject->QueryInterface(IID_IVBDSC, (void**)&pDSC);
	if (FAILED(hRes))
		return hRes;
	ICursor* pCursor;
