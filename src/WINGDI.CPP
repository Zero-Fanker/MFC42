...
static CHandleMap* afxMapHDC(BOOL bCreate = FALSE);

static CHandleMap* afxMapHDC(BOOL bCreate)
{
...
static CHandleMap* afxMapHGDIOBJ(BOOL bCreate = FALSE);
